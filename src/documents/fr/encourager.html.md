...
#### Accès rapide
- [Le projet](#mokatori)
- [Le mécénat participatif](#mecenat-participatif)
- [Description des contreparties](#contreparties)
- [La BD libre et numérique au XXIème siècle](#bd-libre-et-numerique)
- [À quoi va servir le financement ?](#financement)
...
L'idée a pris forme fin 2014, j'ai commencé l'écriture et le storyboard en 2015 puis publié [une petite BD « à côté » sur le même thème](/fr/bd/climat-grenouilles) en octobre 2015 avant la COP21 qui m'a permis de tester le processus de création et de publication d'une BD du début à la fin. Suite à ma participation à la COP21 à Paris (à [Place To B](http://www.placetob.org) !), j'ai finalisé le scénario en 2016, pour publier cet épisode 0 sous forme numérique en septembre 2016. Je suis en train de dessiner l'épisode 1, et les autres suivront dans les mois qui viennent en fonction de mes disponibilités, publiés aussi sur le web et sous forme d'ebook. Je vise la publication de tous les épisodes pour fin 2017, et j'espère imprimer la BD avec l'intégral des épisodes à ce moment-là.
...
À voir sur le sujet, [le documentaire « Sous les bulles » de Maiana Bidegain](https://www.youtube.com/watch?v=IilOp2Te_zg), ou [la parodie écrite par BDencre](http://www.bdencre.com/2015/08/17631_exclusif-un-auteur-de-bd-reussit-a-se-sortir-un-salaire-decouvrez-comment/).
...
Heureusement, on est en 2016, et Internet existe. Et l'auto-édition aussi. Et il a des tas de gens qui ont des bonnes idées et qui montrent le chemin ([Jason Brubaker](http://www.coffeetablecomics.com/), [David Revoy](https://www.patreon.com/davidrevoy), [Maliki](http://maliki.com/strips/a-croisee-chemins/), [Bookelis](http://www.bookelis.com/)). Alors j'ai une autre solution : m'adresser à toi, chère lectrice ou cher lecteur, pour te demander ton soutien.   
...
![Contreparties](/website-img/support/contreparties-thumb.jpg)
...
J'ai déjà publié [une petite BD](/fr/bd/climat-grenouilles) et [de nombreuses illustrations](/fr/illustration) sous licence libre téléchargeables comme fond d'écran, sur mon site web,  et j'ai participé à l'écriture de deux manuels sur mes outils quotidiens ([Scribus](http://www.flossmanualsfr.net/scribus/), [Blender pour le jeu vidéo](http://www.flossmanualsfr.net/blender-pour-le-jeu-video/)).
